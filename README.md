...
1. NVIDIA Jetson Nano Developer Kit -- This is the Jetson Nano AI Computer that will be the core of the Blinkr device. This computer will be doing all of the AI and running the code. We will be connecting things such as a camera to this device.
...
The web cam can be connect via USB. To connect the Raspberry Pi Camera V2 to the Jetson Nano, follow this [video](https://www.youtube.com/watch?v=dHvb225Pw1s). If you are using a Web Cam comment out this line in `blinkr.py`:
...
If you are using the Raspberry Pi Camera V2 then comment out this line in `blinkr.py`:
...
Install the Python3 dependencies using pip3.
